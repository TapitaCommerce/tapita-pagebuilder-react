            ...
            for (let i = 0; i < 12; i++) {
                products.push(
                    <div
                        key={i}
                        style={{
                            width: 170, paddingTop: 250, backgroundRepeat: 'no-repeat',
                            flexShrink: 0
                        }}>
            ...
            for (let i = 0; i < 6; i++) {
                products.push(
                    <div
                        key={i}
                        style={{
                            background: `url("${product_item_mockup}")`, backgroundSize: 'contain',
                            backgroundPosition: 'center top',
                            minWidth: 170, width: '30%', paddingTop: '45%', backgroundRepeat: 'no-repeat',
                            flexShrink: 0
                        }} />)
            }
            return (
